...
start_one() {
  ...
  (
    ...
    echo physical_reason=v7_complete9_nonpeg_focus4_pinned2_generation
    \${GEN} \
...
echo bundle=fix3_v7_nonpeg_focus4_pinned2
echo reason=extra disjoint-seed parallelism for scarce non-peg classes before peg_drop_or_peg_disturb

start_one 0 nonpeg_focus4b_constant_aux90_seedbase19250000 hole_late_constant hole_late_constant=90 hole_late_constant=19250000 90 9300
start_one 1 nonpeg_focus4b_continuous_aux120_seedbase19241000 hole_late_continuous_insert hole_late_continuous_insert=120 hole_late_continuous_insert=19241000 120 9400
start_one 2 nonpeg_focus4b_sine_aux90_seedbase19251000 hole_late_sine hole_late_sine=90 hole_late_sine=19251000 90 9520
start_one 3 nonpeg_focus4b_move_stop_aux70_seedbase19280000 hole_late_move_stop hole_late_move_stop=70 hole_late_move_stop=19280000 70 9620

wait
echo focus4_pinned2_finished=\$(date -Is)
"
