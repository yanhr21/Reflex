...
OUTPUT_ROOT="${OUTPUT_ROOT:-experiments/world_model_task_rebinding/cosmos3/candidate_executor_train_${STAMP}}"
...
schema=cosmos3_candidate_executor_train_wrapper_v1
...
boundary=Candidate executor training wrapper. It does not launch live eval; video/final-state evidence needs a separate gated live panel.
EOF
